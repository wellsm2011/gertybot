...
public class PlayerEvent implements Serializable {
    //private final static Logger LOGGER = Logger.getLogger(PlayerEvent.class.getName());

    @SuppressWarnings("compatibility:6068195206944714646")
     ...
     *
     * @param text The text to display on the event.
     * @param round The round this event occured.
     * @param postLink URL to the post this event was created.
     */
