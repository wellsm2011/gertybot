...
public class ForumLogin extends ForumUser {
    @SuppressWarnings("compatibility:8977146160834785994")
    private static final long serialVersionUID = -8865347377571642240L;

    public final String password;

    /**
     * @param u The user ID of this user.
     * @param name The displayed name of this user.
     * @param password The password to access this user's account.
     * @param context The forum context this user belongs to.
     */
    ...
    /**
     * @param oth The forum user this login is for.
